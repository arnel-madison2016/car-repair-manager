    ...
    <body>
        ...
        @if ($appointment->status === 'confirmed')
            ...
            <p style="display:inline-block; width:65%; margin: 2% 15%; font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; text-align: justify; font-size: 1.4em; line-height: 1.5em;">
                We are pleased to inform you that your request for an appointment on <strong>{{ \Carbon\Carbon::parse($appointment->selected_date)->translatedFormat('F d Y') }}</strong>
                for the diagnosis of your vehicle, registration number <strong>{{ strtoupper($appointment->vehicule->license_plate) }}</strong>, has been confirmed.
                <br/><br/>
        ...
        @else
            ...
            <p style="display:inline-block; width:65%; margin: 2% 15%; font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; text-align: justify; font-size: 1.4em; line-height: 1.5em;">
                Due to the maintenance of our technical facilities, we regret to inform you that your request for an appointment on <strong>{{ \Carbon\Carbon::parse($appointment->selected_date)->translatedFormat('F d Y') }}</strong>
                for the diagnosis of your vehicle, registration number <strong>{{ strtoupper($appointment->vehicule->license_plate) }}</strong>, cannot be processed.
                <br/><br/>
